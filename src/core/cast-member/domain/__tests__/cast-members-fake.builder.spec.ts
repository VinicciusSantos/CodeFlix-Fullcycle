...
type FakerKey = keyof typeof CastMemberFakeBuilder<CastMember>;
...
describe('CastMemberFakerBuilder Unit Tests', () => {
  describe('cast_member_id prop', () => {
    ...
    test('withCastMemberId', () => {
      ...
      expect(faker['_cast_member_id' as FakerKey]()).toBe(cast_member_id);
  ...
  describe('name prop', () => {
    ...
    test('withName', () => {
      ...
      expect(faker['_name'as FakerKey]()).toBe('test name');
    ...
    test('invalid too long case', () => {
      ...
      expect($this).toBeInstanceOf(CastMemberFakeBuilder);
      expect(faker['_name' as FakerKey].length).toBe(256);
  ...
  describe('type prop', () => {
    ...
    test('withType', () => {
      ...
      expect(faker['_type'as FakerKey]()).toEqual(actor);
  ...
  describe('created_at prop', () => {
    ...
    test('withCreatedAt', () => {
      ...
      expect(faker['_created_at'as FakerKey]()).toBe(date);
