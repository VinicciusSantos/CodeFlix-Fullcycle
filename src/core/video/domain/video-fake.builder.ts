...
import {
  Video,
  VideoId,
} from './video.aggregate';
import { CategoryId } from '../../category/domain/category.aggregate';
import { Rating } from './rating.vo';
import { ImageMedia } from '@core/shared/domain/value-objects';
...
export class VideoFakeBuilder<TBuild = any> {
  ...
  public get categories_id(): CategoryId[] {
  ...
  public get cast_members_id(): CastMemberId[] {
  ...
  public static aVideoWithoutMedias() {
  ...
  public static aVideoWithAllMedias() {
    return new VideoFakeBuilder<Video>();
  }

  public static theVideosWithoutMedias(countObjs: number) {
  ...
  public static theVideosWithAllMedias(countObjs: number) {
    return new VideoFakeBuilder<Video[]>(countObjs);
  }
  ...
  public withVideoId(valueOrFactory: PropOrFactory<VideoId>) {
    this._video_id = valueOrFactory;
    return this;
  }

  public withTitle(valueOrFactory: PropOrFactory<string>) {
    this._title = valueOrFactory;
    return this;
  }

  public withDescription(valueOrFactory: PropOrFactory<string>) {
    this._description = valueOrFactory;
    return this;
  }

  public withYearLaunched(valueOrFactory: PropOrFactory<number>) {
    this._year_launched = valueOrFactory;
    return this;
  }

  public withDuration(valueOrFactory: PropOrFactory<number>) {
    this._duration = valueOrFactory;
    return this;
  }

  public withRating(valueOrFactory: PropOrFactory<Rating>) {
    this._rating = valueOrFactory;
    return this;
  }

  public withMarkAsOpened() {
    this._opened = true;
    return this;
  }

  public withMarkAsNotOpened() {
    this._opened = false;
    return this;
  }

  public withBanner(valueOrFactory: PropOrFactory<ImageMedia | null>) {
    this._banner = valueOrFactory;
    return this;
  }

  public withoutBanner() {
    this._banner = null;
    return this;
  }

  public withThumbnail(valueOrFactory: PropOrFactory<ImageMedia | null>) {
    this._thumbnail = valueOrFactory;
    return this;
  }

  public withoutThumbnail() {
    this._thumbnail = null;
    return this;
  }

  public withThumbnailHalf(valueOrFactory: PropOrFactory<ImageMedia | null>) {
    this._thumbnail_half = valueOrFactory;
    return this;
  }

  public withoutThumbnailHalf() {
    this._thumbnail_half = null;
    return this;
  }

  public withTrailer(valueOrFactory: PropOrFactory<Trailer | null>) {
    this._trailer = valueOrFactory;
    return this;
  }

  public withTrailerComplete() {
  ...
  public withoutTrailer() {
    this._trailer = null;
    return this;
  }

  public withVideo(valueOrFactory: PropOrFactory<VideoMedia | null>) {
    this._video = valueOrFactory;
    return this;
  }

  public withVideoComplete() {
  ...
  public addCategoryId(valueOrFactory: PropOrFactory<CategoryId>) {
    this._categories_id.push(valueOrFactory);
    return this;
  }

  public addGenreId(valueOrFactory: PropOrFactory<GenreId>) {
    this._genres_id.push(valueOrFactory);
    return this;
  }

  public addCastMemberId(valueOrFactory: PropOrFactory<CastMemberId>) {
    this._cast_members_id.push(valueOrFactory);
    return this;
  }

  public withInvalidTitleTooLong(value?: string) {
  ...
  public build(): TBuild {
    const videos = new Array(this.countObjs).fill(undefined).map((
      _,
      index,
    ) => {
