...
import {
  ...
  UpdateCastMemberInputConstructorProps,
} from '@core/cast-member/application/use-cases';
import {
  CreateCastMemberDto,
  SearchCastMemberDto,
  UpdateCastMemberDto,
...
export class CastMembersController {
  ...
  async update(
    ...
    const input = new UpdateCastMemberInput({ id, ...updateCastMemberDto } as UpdateCastMemberInputConstructorProps);
