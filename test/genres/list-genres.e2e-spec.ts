...
import { CATEGORY_PROVIDERS } from '../../src/nest-modules/categories-module';

describe('GenresController (e2e)', () => {
  describe('/genres-module (GET)', () => {
    describe('should return genres-module sorted by created_at when request query is empty', () => {
    ...
    describe('should return genres-module using paginate, filter and sort', () => {
      let genreRepo: IGenreRepository;
      let categoryRepo: ICategoryRepository;
